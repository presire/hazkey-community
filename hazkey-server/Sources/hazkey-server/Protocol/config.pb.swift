...
nonisolated struct Hazkey_Config_Profile: @unchecked Sendable {
  ...
  /// Returns true if `acceptPredictionHotkey` has been explicitly set.
  var hasAcceptPredictionHotkey: Bool {_storage._acceptPredictionHotkey != nil}
  ...
  /// Returns true if `zenzaiToggleHotkey` has been explicitly set.
  var hasZenzaiToggleHotkey: Bool {_storage._zenzaiToggleHotkey != nil}
  /// Clears the value of `zenzaiToggleHotkey`. Subsequent reads from it will return its default value.
...
nonisolated extension Hazkey_Config_Profile: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._acceptPredictionHotkey {
        try visitor.visitSingularStringField(value: v, fieldNumber: 125)
      } }()
      try { if let v = _storage._zenzaiToggleHotkey {
